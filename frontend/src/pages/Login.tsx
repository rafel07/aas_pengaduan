        ...
        <div className="hidden lg:flex flex-col justify-center p-14 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100 text-lg leading-10 max-w-xl">
              ...
              mengirim laporan, memantau status pengaduan,
              dan mendapatkan layanan publik digital secara aman.
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-gray-200 bg-gray-50 px-5 py-5 pr-14 outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition"
                />
